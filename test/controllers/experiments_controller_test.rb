...
class ExperimentsControllerTest < ActionController::TestCase
  ...
  test "should create experiment" do
    assert_difference('Experiment.count') do
      post :create, experiment: { description: @experiment.description, link: @experiment.link, name: @experiment.name }
    end
  ...
  test "should update experiment" do
    patch :update, id: @experiment, experiment: { description: @experiment.description, link: @experiment.link, name: @experiment.name }
    assert_redirected_to experiment_path(assigns(:experiment))
  end
